    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="{{ route('user.update',$edit->id ) }}" autocomplete="off" enctype="multipart/form-data">
              @csrf
                    ...
                    <div class="col-md-7 pr-1">
                      <div class="form-group">
                        ...
                        <select name="role" class="form-control">
                          <option value="0"{{ $edit->Role() == 'Super_user' ? 'selected' : '' }}>Super user</option>
                          <option value="1"{{ $edit->Role() == 'User' ? 'selected' : '' }}>User</option>
                        </select>
